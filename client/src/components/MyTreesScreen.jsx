            ...
            <div className="container px-16 mt-10 mb-10 mx-auto">
              <div className="flex flex-wrap -m-4 text-center justify-center">
                <div className="p-4">
                  ...
                  <p className="leading-relaxed">Total Contributions by me!</p>
                </div>
              </div>
            </div>
          </section>
...
// function MyTreesScreen({ connectWallet, walletStatus, isConnected }) {
//   const [id1Owned, setId1Owned] = useState(0);
//   const [id2Owned, setId2Owned] = useState(0);
//   const [id3Owned, setId3Owned] = useState(0);
//   const [id4Owned, setId4Owned] = useState(0);
...
//   useEffect(() => {
//     // Your code to fetch the NFT ownership and update state goes here
//     // Replace this with your actual logic
//     // Example:
//     if (isConnected) {
//       // Fetch NFT ownership and update state
//       // setId1Owned(newValue);
//       // setId2Owned(newValue);
//       // setId3Owned(newValue);
//       // setId4Owned(newValue);
//       // setId5Owned(newValue);
//     }
//   }, [isConnected]);
...
//     <div>
//       {isConnected ? (
//         // Your NFT form and related content goes here
//         // Replace this with your actual form and content
//         <div>
//           <h2>Tree Dashboard Form</h2>
//           <p>ID1 Owned: {id1Owned}</p>
//           <p>ID2 Owned: {id2Owned}</p>
//           <p>ID3 Owned: {id3Owned}</p>
//           <p>ID4 Owned: {id4Owned}</p>
//           <p>ID5 Owned: {id5Owned}</p>
//         </div>
//       ) : (
